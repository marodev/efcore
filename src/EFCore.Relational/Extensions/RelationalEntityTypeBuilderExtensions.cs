...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class RelationalEntityTypeBuilderExtensions
    {
        ...
        {
            buildAction(new TableBuilder(null, null, entityTypeBuilder.Metadata, entityTypeBuilder));
        ...
        public static EntityTypeBuilder<TEntity> ToTable<TEntity>(
            ...
            where TEntity : class
        {
            buildAction(new TableBuilder<TEntity>(null, null, entityTypeBuilder.Metadata, entityTypeBuilder));
            ...
            Action<TableBuilder> buildAction)
        {
            ...
            buildAction(new TableBuilder(name, schema, entityTypeBuilder.Metadata, entityTypeBuilder));
            entityTypeBuilder.Metadata.SetTableName(name);
            entityTypeBuilder.Metadata.SetSchema(schema);
            ...
            where TEntity : class
        {
            ...
            buildAction(new TableBuilder<TEntity>(name, schema, entityTypeBuilder.Metadata, entityTypeBuilder));
            entityTypeBuilder.Metadata.SetTableName(name);
            entityTypeBuilder.Metadata.SetSchema(schema);
